...
const skilllevel = [
  { level: 'L4', description: '指導・管理できる/大会社にて制度の設計から運用までできる（予算）' },
  { level: 'L3', description: '自分で判断しながら処理することができる/単体会社にて制度の設定から運用までできる（予算）' },
  { level: 'L2', description: '指導を受けながら一通り処理することができる/自身で判断しながら決まったものへの入力ができる（予算）' },
  { level: 'L1', description: '指導を受けながら一部処理することができる/指導をうけながら決まったものへの入力ができる（予算）' },
  { level: 'L0', description: '実務経験は求めない' }
];
