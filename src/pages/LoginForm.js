...
const LoginForm = () => {
  ...
  return (
    ...
    <div style={{textAlign:'left'}}>
        <Typography variant="paragraph" gutterBottom sx={{marginTop:'5px'}} >あなたの会員ID（メールアドレス）とパスワードを入力し、「ログイン」ボタンを押してください。<br />会員登録がまだの方は, <a href="/">会員登録</a>を行ってください。 </Typography> 
    </div>
    ...
    <Typography variant="body1" gutterBottom sx={{textAlign:'left', marginTop:'5px'}} > <a href="/forgetpassword" > パスワードをお忘れですか？ </a>    </Typography> 
    <div style={{textAlign:'left'}}>
      <FormControlLabel
        control={
          <Checkbox
