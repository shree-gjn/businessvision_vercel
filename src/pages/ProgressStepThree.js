    ...
    <Card sx={{ minWidth: 275, marginBottom:'30px', marginTop:'10px' }} onClick={handleCardClick}>
      <CardContent>
        ...
        <Grid container spacing={1}>
            ...
            <Grid item xs={4}>
            <Item sx={{fontSize:'12px', background:'rgba(151, 71, 255, 0.20)', marginBottom:'5px'}}>労働条件通知</Item>
            </Grid>
        </Grid>
        </Box>
    ...
    <Card sx={{ minWidth: 275, marginBottom:'30px', marginTop:'10px' }} onClick={handleCardClick}>
      <CardContent>
        ...
        <Grid container spacing={1}>
            ...
            <Grid item xs={4}>
            <Item sx={{fontSize:'12px', background:'rgba(217, 120, 213, 0.20)', marginBottom:'5px'}}>内定受諾</Item>
            </Grid>
        </Grid>
        </Box>
        <Typography variant="h6" component="div" sx={{fontSize:'12px', fontWeight:'700', textAlign:'left'}}>
