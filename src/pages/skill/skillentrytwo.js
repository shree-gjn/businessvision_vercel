...
const Skillentrytwo = ({onBack, onNext}) => {
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} sx={{display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
            <Item sx={{width: '70%', position: 'relative', padding: '0'}}>
              ...
              <div style={{width: '16.66%', background: '#16375A', height: '12px', position: 'absolute', top: '0', left: '0', borderRadius: '15px 0 0 15px'}}></div>
            </Item>
            <Item>
              2/12 ページ
            </Item>
          ...
          <Grid item xs={12}>
            ...
            <Item>
              ...
              <Typography variant="h6" align="left" sx={{fontSize: '12px'}}>
                売上計上、仕入計上、在庫計上、売掛金・買掛金・ 未払金残高照会、消費税チェック、納税関連仕訳
              </Typography>
            </Item>
