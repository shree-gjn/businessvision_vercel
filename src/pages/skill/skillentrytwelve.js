...
const Skillentrytwelve = ({onBack, onNext}) => {
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} sx={{display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
            <Item sx={{width: '70%', position: 'relative', padding: '0'}}>
              ...
              <div style={{width: '100%', background: '#16375A', height: '12px', position: 'absolute', top: '0', left: '0', borderRadius: '15px'}}></div>
            </Item>
            <Item>
              12/12 ページ
            </Item>
          ...
          <Grid item xs={12}>
            ...
            <Item>
              ...
              キャッシュフロー計算書、決算短信、四半期報告書、 有価証券報告書、関連当事者情報、時価情報、注記 情報 
              </Typography>
            </Item>
...
export default Skillentrytwelve;
