...
const Skillentrysix = ({onBack, onNext}) => {
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} sx={{display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
            <Item sx={{width: '70%', position: 'relative', padding: '0'}}>
              ...
              <div style={{width: '49.98%', background: '#16375A', height: '12px', position: 'absolute', top: '0', left: '0', borderRadius: '15px 0 0 15px'}}></div>
            </Item>
            <Item>
              6/12 ページ
            </Item>
          ...
          <Grid item xs={12}>
            ...
            <Item>
              ...
              入退社事務、算定基礎届、賞与支払届、離職票、労 働保険申告、産前産後休暇、育児休暇              
              </Typography>
            </Item>
