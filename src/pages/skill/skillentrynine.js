...
const Skillentrynine = ({onBack, onNext}) => {
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} sx={{display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
            <Item sx={{width: '70%', position: 'relative', padding: '0'}}>
              ...
              <div style={{width: '74.97%', background: '#16375A', height: '12px', position: 'absolute', top: '0', left: '0', borderRadius: '15px 0 0 15px'}}></div>
            </Item>
            <Item>
              9/12 ページ
            </Item>
