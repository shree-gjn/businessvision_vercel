...
const Skillentryseven = ({onBack, onNext}) => {
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12}>
            <Item sx={{fontSize: '12px', display: 'flex', width: '100%', padding: '0', background: '#EEEEEE'}}>
              <div style={{width: '20%', padding: '8px', textAlign: 'right'}}>一般会計</div>
              <div style={{width: '20%', padding: '8px', textAlign: 'right'}}>管理会計​</div>
              <div style={{width: '20%', padding: '8px'}}>社保給与</div>
              <div style={{width: '20%', padding: '8px', background: '#16375A', color: '#fff', position: 'relative'}}>税務 <span style={{display: 'block', borderTop: '17px solid transparent', borderLeft:'10px solid #16375A', borderBottom: '17px solid transparent', position: 'absolute', top: '0', right: '0', marginRight: '-9px'}}></span></div>
              <div style={{width: '20%', padding: '8px', textAlign: 'right'}}>上場会計</div>
            </Item>
          </Grid>
          ...
          <Grid item xs={12} sx={{display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
            <Item sx={{width: '70%', position: 'relative', padding: '0'}}>
              ...
              <div style={{width: '58.31%', background: '#16375A', height: '12px', position: 'absolute', top: '0', left: '0', borderRadius: '15px 0 0 15px'}}></div>
            </Item>
            <Item>
              7/12 ページ
            </Item>
          ...
          <Grid item xs={12}>
            ...
            <Item>
              ...
              インボイス、消費税区分、仮受仮払消費税チェック、 簡易課税、免税判定、仕入税額控除（個別対応・一 括比例）、課税売上割合、消費税計算、税務申告書 作成           
              </Typography>
            </Item>
...
export default Skillentryseven;
