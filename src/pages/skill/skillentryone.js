        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} sx={{display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
            <Item sx={{width: '70%', position: 'relative', padding: '0'}}>
              ...
              <div style={{width: '8.33%', background: '#16375A', height: '12px', position: 'absolute', top: '0', left: '0', borderRadius: '15px 0 0 15px'}}></div>
            </Item>
            <Item>
              1/12 ページ
            </Item>
          ...
          <Grid item xs={12}>
            ...
            <Item>
              ...
              <Typography variant="h6" align="left" sx={{fontSize: '12px'}}>
                現金入出金、預金入出金、一般経理、源泉所得税、給与、社会保険、預金利息、配当金、消費税区分、インボイス
              </Typography>
            </Item>
