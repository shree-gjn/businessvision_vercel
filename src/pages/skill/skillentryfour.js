...
const Skillentryfour = ({onBack, onNext}) => {
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12}>
            <Item sx={{fontSize: '12px', display: 'flex', width: '100%', padding: '0', background: '#EEEEEE'}}>
              ...
              <div style={{width: '20%', padding: '8px', background: '#16375A', color: '#fff', position: 'relative'}}>管理会計​ <span style={{display: 'block', borderTop: '17px solid transparent', borderLeft:'10px solid #16375A', borderBottom: '17px solid transparent', position: 'absolute', top: '0', right: '0', marginRight: '-9px'}}></span></div>
              <div style={{width: '20%', padding: '8px', textAlign: 'right'}}>社保給与</div>
          ...
          <Grid item xs={12} sx={{display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
            <Item sx={{width: '70%', position: 'relative', padding: '0'}}>
              ...
              <div style={{width: '33.32%', background: '#16375A', height: '12px', position: 'absolute', top: '0', left: '0', borderRadius: '15px 0 0 15px'}}></div>
            </Item>
            <Item>
              4/12 ページ
            </Item>
          ...
          <Grid item xs={12}>
            ...
            <Item>
              ...
              <Typography variant="h6" align="left" sx={{fontSize: '12px'}}>
                予算作成、実績分析、部門別・事業部別管理、シス テム導入、グループ予算管理             
              </Typography>
            </Item>
