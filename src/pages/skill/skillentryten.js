...
const Skillentryten = ({onBack, onNext}) => {
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} sx={{display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
            <Item sx={{width: '70%', position: 'relative', padding: '0'}}>
              ...
              <div style={{width: '83.33%', background: '#16375A', height: '12px', position: 'absolute', top: '0', left: '0', borderRadius: '15px 0 0 15px'}}></div>
            </Item>
            <Item>
              10/12 ページ
            </Item>
          ...
          <Grid item xs={12}>
            ...
            <Item>
              ...
              資産除去債務、減損会計、研究開発費、金融商品会 計、収益認識会計、退職給付会計、企業結合会計、 リース会計、ストックオプション会計、税効果会計            
              </Typography>
            </Item>
